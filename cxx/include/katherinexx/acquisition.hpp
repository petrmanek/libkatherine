...
enum class acq_state {
    ...
    running     = KATHERINE_ACQUISITION_STATE_RUNNING,
    succeeded   = KATHERINE_ACQUISITION_STATE_SUCCEEDED,
...
// px_mode itself now lives in config.hpp (see the comment there); this
