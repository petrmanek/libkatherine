...
Load with `wireshark -X lua_script:katherine.lua`, or drop the file into your personal Lua plugins folder (Wireshark: *Help -> About Wireshark -> Folders*) to load it automatically every run.
