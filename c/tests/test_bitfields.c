...
/* ------------------------------------------------------------------ */
/* pmd_f_event_itot: hit_count @ 0/4, event_count @ 4/10, integral_tot  */
/* @ 14/14, coord_x @ 28/8, coord_y @ 36/8 -- same layout as            */
/* pmd_f_toa_tot, renamed fields                                       */
...
test_pmd_f_event_itot_extract(void)
{
    ...
    KT_CHECK_EQ(EXTRACT(w, pmd_f_event_itot, hit_count), DEMO_4);
    ...
    KT_CHECK_EQ(EXTRACT(w_max, pmd_f_event_itot, hit_count), MASK(4));
}

/* ------------------------------------------------------------------ */
/* pmd_event_itot: event_count @ 4/10, integral_tot @ 14/14, coord_x @  */
/* 28/8, coord_y @ 36/8 -- bits 0-3 are unused in this layout (no       */
/* hit_count field)                                                    */
